...
print(width,height,focal_x,focal_y,center_x,center_y)
...
print('width,height,focal_x,focal_y,center_x,center_y',width,height,focal_x,focal_y,center_x,center_y)
