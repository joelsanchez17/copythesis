...
def panda_link0_collision(_in0, tensor_kwargs=None):
    ...
    cte_1 = torch.tensor(0.0, **tensor_kwargs)
    cte_2 = torch.tensor(-0.68, **tensor_kwargs)
    cte_3 = torch.tensor(0.085, **tensor_kwargs)
    cte_4 = torch.tensor(0.05, **tensor_kwargs)
    cte_5 = torch.tensor(-0.62, **tensor_kwargs)
    cte_6 = torch.tensor(-0.71, **tensor_kwargs)
    cte_7 = torch.tensor(-0.65, **tensor_kwargs)
    cte_8 = torch.tensor(0.138, **tensor_kwargs)
    cte_9 = torch.tensor(-0.61, **tensor_kwargs)
    cte_10 = torch.tensor(-0.6, **tensor_kwargs)
    cte_11 = torch.tensor(-0.74, **tensor_kwargs)
