...
def panda_link3_collision(_in0, tensor_kwargs=None):
    ...
    _tmp10 = cte_7 * _tmp9
    _tmp11 = -_tmp10 * _tmp8 - _tmp4 * _tmp6 + cte_8
    _tmp12 = _tmp4 * _tmp7
    _tmp13 = _tmp5 * _tmp9
    _tmp14 = cte_4 * _tmp13
    _tmp15 = (
        ...
        [
            _broadcast_and_stack(
                [
                    ...
                    _tmp1 * _tmp3 + cte_8,
                    _tmp11 + _tmp15,
                    _tmp15 - _tmp16 * _tmp4 - _tmp17 * _tmp8 + cte_8,
                    _tmp1 * _tmp18
                    + _tmp1 * _tmp19
                    + _tmp11
                    - cte_2 * _tmp12,
