...
def panda_link4_collision(_in0, tensor_kwargs=None):
    ...
    _tmp12 = cte_4 * _tmp4
    _tmp13 = (
        -_tmp0 * _tmp10 + _tmp11 * _tmp12 + _tmp3 * _tmp9 + cte_10
    )
    _tmp14 = _tmp3 * _tmp6
    ...
    _tmp29 = _tmp13 - cte_4 * _tmp21 - _tmp28 * _tmp3
    ...
    _tmp37 = -_tmp0 * _tmp28 + _tmp30 - cte_4 * _tmp36
    _tmp38 = _tmp5 * _tmp8
    _tmp39 = _tmp1 * _tmp27
    _tmp40 = (
        -_tmp39
    ...
    _tmp46 = _tmp20 * _tmp39 + _tmp40 - cte_4 * _tmp41
    ...
    _out = _broadcast_and_stack(
        [
            _broadcast_and_stack(
                [
                    _tmp13 + cte_8 * _tmp2 + _tmp3 * _tmp7,
                    _tmp13
                    + cte_9 * _tmp14
                    + cte_9 * _tmp2,
                    _tmp13
            ...
            _broadcast_and_stack(
                [
                    _tmp0 * _tmp7 - cte_8 * _tmp11 + _tmp30,
                    -cte_9 * _tmp11
                    + _tmp30
                    + cte_9 * _tmp31,
                    _tmp0 * _tmp22
