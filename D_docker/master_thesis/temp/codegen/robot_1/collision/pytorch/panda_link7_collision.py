...
def panda_link7_collision(_in0, tensor_kwargs=None):
    ...
    cte_4 = torch.tensor(0.06, **tensor_kwargs)
    ...
    _tmp15 = _tmp14 * _tmp6
    _tmp16 = -_tmp0 * _tmp11 + cte_3 * _tmp15
    ...
    _tmp24 = _tmp0 * _tmp13
    _tmp25 = _tmp24 * _tmp6
    _tmp26 = cte_3 * torch.cos(_in0[..., 4])
    _tmp27 = -_tmp23 * (_tmp20 + _tmp21 * _tmp5) + _tmp26 * (
        _tmp11 * _tmp12 + cte_3 * _tmp25
    )
    ...
    _tmp41 = -_tmp23 * (_tmp4 * _tmp5 - _tmp9) + _tmp26 * (
        _tmp12 * _tmp40 + cte_3 * _tmp38
    )
    _tmp42 = _tmp19 * _tmp41
    _tmp43 = _tmp1 * _tmp14
    _tmp44 = -_tmp0 * _tmp40 + cte_3 * _tmp43
    _tmp45 = (
        _tmp1 * _tmp31
        + _tmp1 * _tmp35
        - _tmp29 * _tmp39
    ...
    _tmp49 = _tmp13 * _tmp22 * _tmp3 + _tmp26 * (
        -_tmp12 * _tmp48 + cte_3 * _tmp46
    )
    _tmp50 = _tmp19 * _tmp49
    _tmp51 = _tmp12 * _tmp5
    _tmp52 = _tmp0 * _tmp48 + cte_3 * _tmp51
    _tmp53 = (
        _tmp29 * _tmp47
        + _tmp30 * _tmp47
        + _tmp33 * _tmp52
    ...
    _out = _broadcast_and_stack(
        [
            _broadcast_and_stack(
                [
                    -_tmp16 * _tmp18 + cte_4 * _tmp28 + _tmp36,
                    -_tmp16 * _tmp37 + cte_7 * _tmp28 + _tmp36,
                ],
                dim=-1,
            ),
            _broadcast_and_stack(
                [
                    -_tmp18 * _tmp44 + cte_4 * _tmp42 + _tmp45,
                    -_tmp37 * _tmp44 + cte_7 * _tmp42 + _tmp45,
                ],
                dim=-1,
            ),
            _broadcast_and_stack(
                [
                    -_tmp18 * _tmp52 + cte_4 * _tmp50 + _tmp53,
                    -_tmp37 * _tmp52 + cte_7 * _tmp50 + _tmp53,
                ],
                dim=-1,
            ),
        ],
