...
def group_1(_in0, tensor_kwargs=None):
    ...
    cte_9 = torch.tensor(0.137, **tensor_kwargs)
    ...
    _tmp30 = cte_8 * _tmp15
    _tmp31 = cte_3 * _tmp1
    _tmp32 = cte_10 * _tmp13
    _tmp33 = cte_3 * _tmp3
    _tmp34 = cte_3 * _tmp6 * _tmp8
    _tmp35 = cte_8 * _tmp1
    _tmp36 = cte_3 * _tmp15
    _tmp37 = (
        -_tmp11 * _tmp30
    ...
    _tmp52 = _tmp13 * _tmp20 * _tmp4 + _tmp17 * (
        -_tmp26 * _tmp51 + cte_5 * _tmp50
    )
    _tmp53 = _tmp1 * _tmp6
    _tmp54 = _tmp16 * _tmp51 + cte_5 * _tmp53
