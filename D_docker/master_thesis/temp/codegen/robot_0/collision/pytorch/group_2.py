...
def group_2(_in0, tensor_kwargs=None):
    ...
    _tmp11 = cte_4 * _tmp4
    _tmp12 = _tmp1 * _tmp11
    _tmp13 = _tmp0 * _tmp10 - _tmp12 * _tmp3 - _tmp3 * _tmp9 + cte_1
    _tmp14 = cte_5 * _tmp5
    _tmp15 = cte_5 * _tmp1 * _tmp4
    _tmp16 = _tmp0 * _tmp14 - _tmp15 * _tmp3
    _tmp17 = torch.sin(_in0[..., 3])
    _tmp18 = cte_2 * _tmp17
    _tmp19 = torch.cos(_in0[..., 3])
    _tmp20 = cte_4 * _tmp19
    _tmp21 = cte_2 * _tmp19
    _tmp22 = _tmp21 * _tmp8
    _tmp23 = cte_4 * _tmp8
