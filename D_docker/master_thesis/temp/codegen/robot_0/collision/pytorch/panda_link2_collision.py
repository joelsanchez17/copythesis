...
def panda_link2_collision(_in0, tensor_kwargs=None):
    ...
    cte_2 = torch.tensor(0.075, **tensor_kwargs)
    cte_3 = torch.tensor(0.136, **tensor_kwargs)
    cte_4 = torch.tensor(0.0, **tensor_kwargs)
    cte_5 = torch.tensor(0.04, **tensor_kwargs)
    cte_6 = torch.tensor(0.171, **tensor_kwargs)
    cte_7 = torch.tensor(0.358, **tensor_kwargs)
    cte_8 = torch.tensor(0.07, **tensor_kwargs)
    cte_9 = torch.tensor(0.035, **tensor_kwargs)

    # Intermediate terms (7)
    _tmp0 = torch.sin(_in0[..., 0])
    _tmp1 = torch.cos(_in0[..., 0])
    _tmp2 = torch.sin(_in0[..., 1])
    _tmp3 = cte_6 * _tmp2
    _tmp4 = cte_3 * _tmp2
    _tmp5 = cte_8 * _tmp2
