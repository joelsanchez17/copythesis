...
from pydrake.all import (
    ...
    RenderCameraCore, CameraInfo, ClippingRange, DepthRange, MakeRenderEngineVtk, MeshcatVisualizer
      )
...
def make_complete_plant(base_transforms:list,obstacles:list, meshcat, camera_params:dict = None):
    ...
    franka_robot_urdf = "/workspaces/master_thesis/model/models/franka_description/urdf/panda_arm_hand.urdf"
...
# (robot,) = Parser(plant).AddModelsFromUrl("package://drake_models/franka_description/urdf/panda_arm.urdf")
    ...
    def make_one_robot_plant(base_transform:RigidTransform):
        ...
        parser.package_map().Add("franka_description",
            "/workspaces/master_thesis/model/models/franka_description")

        (robot,) = parser.AddModels(franka_robot_urdf)
        # flag 
        print("Model instance index:", robot)
