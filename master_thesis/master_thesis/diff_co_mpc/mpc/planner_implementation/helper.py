...
class Planner(PlannerMixin):
    ...
    def set_costs(self, vision_cost, duration_cost, acceleration_cost, manipulability_cost, replan_connection_cost,slack_cost_weight ):
    ...
    def set_start_position(self):
        ...
        for opt_data in [self.initial_plan_data, self.parallel_solve_data, self.replan_data]:
            opt_data.set_parameter("object_start_position", self.lcm_subscription_handler.initial_pose[:3,3:4])
            opt_data.set_parameter("object_start_rotation_matrix", self.lcm_subscription_handler.initial_pose[:3,:3])

    def set_end_position(self):
        for opt_data in [self.initial_plan_data, self.parallel_solve_data, self.replan_data]:
            opt_data.set_parameter("object_end_position", self.lcm_subscription_handler.placing_spot_pose[:3,3:4])
            opt_data.set_parameter("object_end_rotation_matrix", self.lcm_subscription_handler.placing_spot_pose[:3,:3])
