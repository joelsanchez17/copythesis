...
def group_3(_in0, tensor_kwargs=None):
    ...
    cte_2 = torch.tensor(0.144, **tensor_kwargs)
    ...
    _out = _broadcast_and_stack(
        [
            _broadcast_and_stack(
                [
                    -cte_2 * _tmp11 + _tmp13 * _tmp15 + _tmp21,
                    -cte_6 * _tmp11
                    + _tmp13 * _tmp22
                    + _tmp21
                    - _tmp25 * (_tmp23 + _tmp24 * _tmp5)
                    - _tmp27 * (_tmp10 * _tmp26 + cte_1 * _tmp20),
                ],
                dim=-1,
            ),
            _broadcast_and_stack(
                [
                    _tmp15 * _tmp28 - cte_2 * _tmp30 + _tmp33,
                    _tmp22 * _tmp28
                    - _tmp25 * (_tmp4 * _tmp5 - _tmp9)
                    - _tmp27
                    * (cte_1 * _tmp1 * _tmp32 + _tmp26 * _tmp29)
                    - cte_6 * _tmp30
                    + _tmp33,
                ],
                dim=-1,
            ...
            _broadcast_and_stack(
                [
                    ...
                    + _tmp38,
                    _tmp12 * _tmp2 * _tmp25
                    - _tmp27 * (-_tmp26 * _tmp35 + cte_1 * _tmp37)
                    + cte_6 * _tmp34
                    + cte_6 * _tmp36
                    + _tmp38,
                ],
