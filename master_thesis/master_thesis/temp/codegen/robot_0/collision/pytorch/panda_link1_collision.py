...
def panda_link1_collision(_in0, tensor_kwargs=None):
    ...
    cte_1 = torch.tensor(0.298, **tensor_kwargs)
    ...
    cte_6 = torch.tensor(0.228, **tensor_kwargs)
    cte_7 = torch.tensor(0.035, **tensor_kwargs)
    cte_8 = torch.tensor(0.04, **tensor_kwargs)
    cte_9 = torch.tensor(0.168, **tensor_kwargs)
    cte_10 = torch.tensor(0.198, **tensor_kwargs)
