...
def panda_link2_collision(_in0, tensor_kwargs=None):
    ...
    cte_1 = torch.tensor(0.075, **tensor_kwargs)
    cte_2 = torch.tensor(0.358, **tensor_kwargs)
    cte_3 = torch.tensor(0.136, **tensor_kwargs)
    cte_4 = torch.tensor(0.535, **tensor_kwargs)
    cte_5 = torch.tensor(0.0, **tensor_kwargs)
    cte_6 = torch.tensor(0.035, **tensor_kwargs)
    cte_7 = torch.tensor(0.07, **tensor_kwargs)
    cte_8 = torch.tensor(0.171, **tensor_kwargs)
    cte_9 = torch.tensor(0.04, **tensor_kwargs)
