...
def group_2(_in0, tensor_kwargs=None):
    ...
    cte_2 = torch.tensor(0.316, **tensor_kwargs)
    cte_3 = torch.tensor(0.104, **tensor_kwargs)
    cte_4 = torch.tensor(0.535, **tensor_kwargs)
    cte_5 = torch.tensor(0.358, **tensor_kwargs)
    cte_6 = torch.tensor(1.0, **tensor_kwargs)
    cte_7 = torch.tensor(0.06, **tensor_kwargs)
    ...
    _tmp11 = cte_1 * _tmp4
    _tmp12 = _tmp1 * _tmp11
    _tmp13 = _tmp0 * _tmp10 - _tmp12 * _tmp3 - _tmp3 * _tmp9 + cte_4
    _tmp14 = cte_6 * _tmp5
    _tmp15 = cte_6 * _tmp1 * _tmp4
