...
def panda_link0_collision(_in0, tensor_kwargs=None):
    ...
    cte_1 = torch.tensor(0.565, **tensor_kwargs)
    cte_2 = torch.tensor(0.525, **tensor_kwargs)
    cte_3 = torch.tensor(0.535, **tensor_kwargs)
    cte_4 = torch.tensor(0.0, **tensor_kwargs)
    cte_5 = torch.tensor(0.065, **tensor_kwargs)
    cte_6 = torch.tensor(0.515, **tensor_kwargs)
    cte_7 = torch.tensor(0.085, **tensor_kwargs)
    cte_8 = torch.tensor(0.108, **tensor_kwargs)
    cte_9 = torch.tensor(-0.05, **tensor_kwargs)
    cte_10 = torch.tensor(0.655, **tensor_kwargs)
    cte_11 = torch.tensor(0.138, **tensor_kwargs)
    cte_12 = torch.tensor(0.05, **tensor_kwargs)
    cte_13 = torch.tensor(0.625, **tensor_kwargs)
    cte_14 = torch.tensor(0.595, **tensor_kwargs)
