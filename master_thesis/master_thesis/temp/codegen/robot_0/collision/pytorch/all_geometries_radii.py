...
def all_geometries_radii(_in0, tensor_kwargs=None):
    ...
    cte_1 = torch.tensor(0.02, **tensor_kwargs)
    cte_2 = torch.tensor(0.035, **tensor_kwargs)
    cte_3 = torch.tensor(0.055, **tensor_kwargs)
    cte_4 = torch.tensor(0.012, **tensor_kwargs)
