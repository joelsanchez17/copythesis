...
def group_3(_in0, tensor_kwargs=None):
    ...
    cte_2 = torch.tensor(0.07, **tensor_kwargs)
    cte_3 = torch.tensor(0.316, **tensor_kwargs)
    cte_4 = torch.tensor(0.384, **tensor_kwargs)
    cte_5 = torch.tensor(0.535, **tensor_kwargs)
    cte_6 = torch.tensor(0.358, **tensor_kwargs)
    cte_7 = torch.tensor(0.144, **tensor_kwargs)
    ...
    _tmp24 = cte_4 * _tmp10
    _tmp25 = cte_2 * torch.sin(_in0[..., 4])
    _tmp26 = cte_4 * _tmp14
    _tmp27 = _tmp0 * _tmp7
    _tmp28 = _tmp2 * _tmp5
    _tmp29 = cte_2 * torch.cos(_in0[..., 4])
    ...
    _out = _broadcast_and_stack(
        [
            ...
            _broadcast_and_stack(
                [
                    _tmp11 * _tmp35 + cte_7 * _tmp34 + _tmp38,
                    _tmp1 * _tmp12 * _tmp29
                    + _tmp24 * _tmp35
                    - _tmp25 * (-_tmp14 * _tmp7 + cte_8 * _tmp36)
                    + cte_4 * _tmp34
                    + _tmp38,
                ],
                dim=-1,
