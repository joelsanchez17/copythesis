...
def panda_link3_collision(_in0, tensor_kwargs=None):
    ...
    cte_3 = torch.tensor(0.246, **tensor_kwargs)
    cte_4 = torch.tensor(0.206, **tensor_kwargs)
    cte_5 = torch.tensor(0.04, **tensor_kwargs)
    cte_6 = torch.tensor(0.316, **tensor_kwargs)
    cte_7 = torch.tensor(0.535, **tensor_kwargs)
    cte_8 = torch.tensor(0.358, **tensor_kwargs)
    ...
    _tmp10 = cte_10 * _tmp9
    _tmp11 = _tmp10 * _tmp8 + _tmp4 * _tmp6 + cte_7
    _tmp12 = _tmp4 * _tmp7
    _tmp13 = _tmp5 * _tmp9
    _tmp14 = cte_1 * _tmp13
    _tmp15 = (
        ...
        [
            _broadcast_and_stack(
                [
                    ...
                    -_tmp1 * _tmp3 + cte_7,
                    _tmp11 + _tmp15,
                    _tmp15 + _tmp16 * _tmp4 + _tmp17 * _tmp8 + cte_7,
                    -_tmp1 * _tmp18
                    - _tmp1 * _tmp19
                    + _tmp11
                    + cte_5 * _tmp12,
