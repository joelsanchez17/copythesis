...
def panda_link4_collision(_in0, tensor_kwargs=None):
    ...
    cte_1 = torch.tensor(0.064, **tensor_kwargs)
    cte_2 = torch.tensor(0.0825, **tensor_kwargs)
    cte_3 = torch.tensor(0.035, **tensor_kwargs)
    cte_4 = torch.tensor(0.03, **tensor_kwargs)
    cte_5 = torch.tensor(0.01, **tensor_kwargs)
    cte_6 = torch.tensor(0.04, **tensor_kwargs)
    cte_7 = torch.tensor(0.316, **tensor_kwargs)
    cte_8 = torch.tensor(0.104, **tensor_kwargs)
    ...
    cte_13 = torch.tensor(0.06, **tensor_kwargs)
    ...
    _tmp11 = _tmp1 * _tmp3
    _tmp12 = cte_2 * _tmp4
    _tmp13 = _tmp0 * _tmp10 - _tmp11 * _tmp12 - _tmp3 * _tmp9 + cte_9
    _tmp14 = _tmp3 * _tmp6
    ...
    _tmp25 = cte_3 * _tmp15
    _tmp26 = cte_11 * _tmp15
    _tmp27 = cte_2 * _tmp8
    _tmp28 = _tmp15 * _tmp27
    _tmp29 = _tmp13 - cte_2 * _tmp21 + _tmp28 * _tmp3
    ...
    _tmp37 = _tmp0 * _tmp28 + _tmp30 - cte_2 * _tmp36
    _tmp38 = _tmp5 * _tmp8
    _tmp39 = _tmp1 * _tmp27
    _tmp40 = (
        -_tmp39
    ...
    _tmp46 = _tmp20 * _tmp39 + _tmp40 - cte_2 * _tmp41
    ...
    _out = _broadcast_and_stack(
        [
            _broadcast_and_stack(
                [
                    _tmp13 - cte_13 * _tmp2 - _tmp3 * _tmp7,
                    _tmp13
                    - cte_4 * _tmp14
                    - cte_4 * _tmp2,
                    _tmp13
            ...
            _broadcast_and_stack(
                [
                    -_tmp0 * _tmp7 + cte_13 * _tmp11 + _tmp30,
                    cte_4 * _tmp11
                    + _tmp30
                    - cte_4 * _tmp31,
                    -_tmp0 * _tmp22
